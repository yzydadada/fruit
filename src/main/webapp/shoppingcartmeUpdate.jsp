...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerAdd">
            <form action="${pageContext.request.contextPath}/shoppingcart/UpdatemeShoppingcart.do" method="post">
    ...
    $(function () {
        $(".btn").on("click",function () {
            ...
            $.ajax({
                type: "post",
                dataType: "JSON",
                url: "${pageContext.request.contextPath}/shoppingcart/UpdatemeShoppingcart.do",
                ...
                success:function (data) {
                    if(data.result==="1") {
                        alert("修改成功");
                        window.location.href = "${pageContext.request.contextPath}/shoppingcart/doshoppingcartmel.do";
                    }
                }
