...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerAdd">
            <form id="user" action="${pageContext.request.contextPath}/user/addmeuser.do" method="post" enctype="multipart/form-data">
...
<%--                </div>--%>
                <div class="providerAddBtn">
                    ...
                    <input type="button" value="返回登录" onclick="history.back(-1)"/>
                </div>
            </form>
        </div>
    ...
    $(function () {
        $(".btn").on("click",function () {
            ...
            $.ajax({
                type: "post",
                dataType: "JSON",
                url: "${pageContext.request.contextPath}/user/addmeuser.do",
                contentType: false,
                cache: false,
                processData: false,
                data: fromData,
                success:function (data) {
                    if(data.result==="1") {
                        alert("添加成功,返回登录");
                        window.location.href = "${pageContext.request.contextPath}/login/doLogin.do";
                    }
                }
